...
/*lift motors*/
pros::Motor LiftLMotor(LiftLMotorPort, pros::E_MOTOR_GEARSET_36, false, pros::E_MOTOR_ENCODER_DEGREES);
pros::Motor LiftRMotor(LiftRMotorPort, pros::E_MOTOR_GEARSET_36, true, pros::E_MOTOR_ENCODER_DEGREES);
/*cube claw motors*/
